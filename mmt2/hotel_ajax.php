...
//            if(isset($_POST['search_hotel'])){
                ...
                $hotel_date = $_GET["flight_dept_date"];
                $no_of_guests = $_GET["no_of_guests"];
                $no_of_rooms = $_GET["no_of_rooms"];
                $off_date = $_GET["flight_ret_date"];
...
//                            <i class=\"fa fa-star empty_hotel_section\"></i>";
                            ...
                            echo "<div style=\"margin-left:15px; margin-top:20px; font-size:18px;\"><label for\"room\">Economy</label><input type=\"radio\" value=\"$economy_price\" name=\"room\" style=\"margin-left:10px;\" checked=\"checked\">";
                            echo "<label style=\"margin-left:50px;\" for\"room\">Deluxe</label><input type=\"radio\" value=\"$deluxe_price\" name=\"room\" style=\"margin-left:10px;\">";
                            echo "<label style=\"margin-left:50px;\"for\"room\">Suite</label><input type=\"radio\" value=\"$suite_price\" name=\"room\" style=\"margin-left:10px;\"></div>";
                            ...
                            <p><a style=\"color:#fff; background:#222; padding:10px;\" href=\"flight_ajax_return.php?source={$source}&destination={$hotel_city}&on_date={$hotel_date}&off_date={$off_date}&no_of_guests={$no_of_guests}&no_of_rooms={$no_of_rooms}&flight_class={$flight_class}&flight_id={$flight_id}&hotel_id={$hotel_id}\" name=\"view_hotel\" value=\"\">Select</a></p>
                        </div>
                    </div>";
                    $row_element_count++;
